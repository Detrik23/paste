...
{
	const char* yTypes[] = {
			"SLOW SPIN", "FAST SPIN", "RANDOM SPIN", "JITTER", "RANDOM BACKJITTER", "BACKJITTER", "SIDE", "BACKWARDS", "FORWARDS", "LEFT", "RIGHT", "STATIC", "STATIC JITTER", "STATIC SMALL JITTER", "LUA", "LUA2", "CASUALAA",// safe
