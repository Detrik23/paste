...
{
	const char* yTypes[] = {
			"SLOW SPIN", "FAST SPIN", "RANDOM SPIN", "LBY SPIN", "JITTER", "RANDOM BACKJITTER", "BACKJITTER", "TURBO JITTER", "SIDE", "BACKWARDS", "FORWARDS", "LEFT", "RIGHT", "STATIC", "STATIC JITTER", "STATIC SMALL JITTER", "LUA", "LUA2", "CASUALAA",// safe
